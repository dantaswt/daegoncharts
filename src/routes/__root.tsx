...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Weekly music charts, year-end rankings and GOAT lists based on dantaswt's Last.fm data. Each week gets its own shareable page." },
      { property: "og:title", content: "daegon charts — weekly music charts" },
      { property: "og:description", content: "Weekly music charts, year-end rankings and GOAT lists based on dantaswt's Last.fm data. Each week gets its own shareable page." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "daegon charts — weekly music charts" },
      { name: "twitter:description", content: "Weekly music charts, year-end rankings and GOAT lists based on dantaswt's Last.fm data. Each week gets its own shareable page." },
